        ...
        <div className="md:flex md:justify-between">
          <div className="flex flex-col justify-between gap-4 mb-6 md:mb-0">
            ...
            <div className="md:w-[95%] lg:w-[80%] xl:w-[60%] text-xs text-gray-400">
              ...
              ipsum auctor, ullamcorper nibh vitae, eleifend ante. Vivamus
              lobortis, mauris sed malesuada lobortis, velit velit lobortis
              odio, sed iaculis enim justo ac turpis.
            </div>
          </div>
